...
ur.gp_plot_lorenz(:title => "Lorenz Curve", :xlabel => "authors",
 :ylabel => "revisions", :pdf => 'cdfar.pdf', :size => '480,480')
%>
\begin{center}
...
coauthorship_network.to_graphviz("coauthorgraph.pdf", "neato -Tpdf", [ "outputorder=edgesfirst;\n", "node [ shape=point, style=filled, fillcolor=white ]" ] ) { |w|  "[ weight=#{w} ]" }
%>
\begin{figure}[htbp]
	\centering
...
page_network.to_graphviz("pagegraph.pdf", "neato -Tpdf", [ "outputorder=edgesfirst;\n", "node [ shape=point, style=filled, fillcolor=white ]" ] ) { |w|  "[ weight=#{w} ]" }
%>
