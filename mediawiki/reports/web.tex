...
ref = {
  ...
  'fig:links_per_week' => "#{count += 1}",
  'fig:cumulative_links_per_week' => "#{count += 1}",
...
\begin{table}
  ...
  \begin{tabularx}{\linewidth}{Xrrrr}\toprule
    ...
    <%=p_table(p_dests, 'by incoming links') %>\\\bottomrule
  \end{tabularx}
\end{table}
...
% Cumulative Links per Week (CLPW)
...
\begin{figure}
	...
	\includegraphics[width=0.95\textwidth]{clpw}
...
\begin{figure}[htbp]
  \parbox[t]{0.48\textwidth}{        
    \includegraphics[width=\linewidth]{author_participation}
    \caption{Author Participation}
    \label{fig:author_participation}}
  \hfill
  \parbox[t]{0.48\textwidth}{        
    \includegraphics[width=\linewidth]{relative_author_participation}
