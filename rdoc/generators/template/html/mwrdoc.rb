# taken from html.rb and kilmer.rb and modified.
...
h1,h2,h3,h4 { margin: 0; color: black; background: transparent; }
h1 { font-size: 150%; }
...
div#index-entries a:hover { background: #039; }
...
#method-list .name-list {  font-size:smaller; }

#constants-list .name-list, #attribute-list .name-list {  
    background: #f0eeee;
    padding: 0.5ex 0.5em;
    margin-top: 0.5em;
    margin-bottom: 1em;
...
START:entries
    <div class="entry"><a href="%href%">%name%</a></div>
END:entries
  </div>
</div>
</body>
